...
# -----------------------------
header_file_path <- "C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/wageo2020.pl"
part1_file_path  <- "C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/wa000012020.pl"
part2_file_path  <- "C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/wa000022020.pl"
part3_file_path  <- "C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/wa000032020.pl"
...
#  P0020010  Some Other Race alone
#  P0020011  Population of two or more races:
setnames(wapop, paste0('P00', 20001:20011), c('total', 'hispanic', 'nothispanic', 'onerace', 'white', 'black', 'aian', 'asian', 'nhpi', 'other', 'multiple'))
setnames(wapop, paste0('P00', 40001:40011), c('total_18', 'hispanic_18', 'nothispanic_18', 'onerace_18', 'white_18', 'black_18', 'aian_18', 'asian_18', 'nhpi_18', 'other_18', 'multiple_18'))

vvv = c('total', 'hispanic', 'white', 'black', 'aian', 'asian', 'nhpi', 'other', 'multiple')
vvv18 = paste0(vvv, '_18')
wapop[, (vvv) := lapply(.SD, as.numeric), .SDcols = vvv]
wapop[, (vvv18) := lapply(.SD, as.numeric), .SDcols = vvv18]
...
pc18 = paste0(pc, '_18')
pcols = c('total', 'total_18', pc, pc18)

pops = lapply(seq_along(levs), function(i){

  pop = wapop[SUMLEV == levs[[i]], .SD, .SDcols = c('COUNTY', 'SUMLEV', 'TRACT', 'BLKGRP', 'BLOCK',pcols )]
  pop[, reagg := rowSums(.SD), .SDcols = pc]
  pop[, reagg_18 := rowSums(.SD), .SDcols = pc18]
  
  pop[, level := names(levs)[i]]
...
# quick manual check to make sure the totals are internally consistent
ctys = pops[, .(t1 = sum(total), t2 = sum(reagg), t3 = sum(total_18), t4 = sum(reagg_18)), by = .(COUNTY, level)]
ctys[COUNTY == '033']

saveRDS(pops, file.path(out, '2020_redist_pop.rds'))

# saveRDS(wablkpop, 'C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/wablkpop.rds')
# 
# wapop[, c(paste0("P00", c(10001:10071, 20001:20073)), paste0("P00", c(30001:30071, 40001:40073)), 
#          paste0("H00", 10001:10003), paste0("P00", 50001:50010)):=NULL]
# 
# #kc cities
# kcc = c("Algona", "Auburn", "Beaux Arts", "Bellevue", "Black Diamond", 
...
# 
# kccities = lapply(kcc, function(x){
#   r = wapop[SUMLEV == 160 & grepl(x, NAME)][, cityname := x]
#   if(nrow(r)>1) r = r[grep('city', NAME)]
#   r
# })
# kccities = rbindlist(kccities)
# saveRDS(kccities, 'C:/Users/dcasey/OneDrive - King County/Downloads/wa2020.pl/kccitiespop.rds')
